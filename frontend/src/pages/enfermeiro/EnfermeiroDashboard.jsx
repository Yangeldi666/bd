...
export default function EnfermeiroDashboard({ token }) {
  ...
  async function carregarAlocacoes() {
    try {
      ...
      setErro("Erro ao carregar alocações do enfermeiro");
    }
  }
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold">Dashboard do Enfermeiro</h1>
